...
|기능|설명|어플 화면|
|--------|------|----------|
|회원가입|사용자는 건강관리 서비스를 이용하기 위해서 회원가입을 해야 한다. <br><br>- 목표, 활동량, 성별, 키, 몸무게, 회원정보 총 3단계를 통한 정보 입력 후 회원가입을 할 수 있다. |![image](https://user-images.githubusercontent.com/75558861/212496581-3d316c1f-55f2-4fa8-a168-a707ca3401f8.png)|
